...
| [azurerm_lb_rule.backend_lb_public_rule](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/lb_rule) | resource |
...
| <a name="input_containers_config_map"></a> [containers\_config\_map](#input\_containers\_config\_map) | Maps the number of objects and memory size per machine type. | <pre>map(object({<br>    compute  = number<br>    drive    = number<br>    frontend = number<br>    nvme     = number<br>    nics     = number<br>    memory   = list(string)<br>  }))</pre> | <pre>{<br>  "Standard_L16as_v3": {<br>    "compute": 4,<br>    "drive": 2,<br>    "frontend": 1,<br>    "memory": [<br>      "72GB",<br>      "73GB"<br>    ],<br>    "nics": 8,<br>    "nvme": 2<br>  },<br>  "Standard_L16s_v3": {<br>    "compute": 4,<br>    "drive": 2,<br>    "frontend": 1,<br>    "memory": [<br>      "79GB",<br>      "72GB"<br>    ],<br>    "nics": 8,<br>    "nvme": 2<br>  },<br>  "Standard_L16s_v4": {<br>    "compute": 4,<br>    "drive": 2,<br>    "frontend": 1,<br>    "memory": [<br>      "79GB",<br>      "72GB"<br>    ],<br>    "nics": 8,<br>    "nvme": 4<br>  },<br>  "Standard_L32as_v3": {<br>    "compute": 4,<br>    "drive": 2,<br>    "frontend": 1,<br>    "memory": [<br>      "190GB",<br>      "190GB"<br>    ],<br>    "nics": 8,<br>    "nvme": 4<br>  },<br>  "Standard_L32s_v3": {<br>    "compute": 4,<br>    "drive": 2,<br>    "frontend": 1,<br>    "memory": [<br>      "197GB",<br>      "189GB"<br>    ],<br>    "nics": 8,<br>    "nvme": 4<br>  },<br>  "Standard_L32s_v4": {<br>    "compute": 4,<br>    "drive": 2,<br>    "frontend": 1,<br>    "memory": [<br>      "197GB",<br>      "189GB"<br>    ],<br>    "nics": 8,<br>    "nvme": 8<br>  },<br>  "Standard_L48as_v3": {<br>    "compute": 3,<br>    "drive": 3,<br>    "frontend": 1,<br>    "memory": [<br>      "308GB",<br>      "308GB"<br>    ],<br>    "nics": 8,<br>    "nvme": 6<br>  },<br>  "Standard_L48s_v3": {<br>    "compute": 3,<br>    "drive": 3,<br>    "frontend": 1,<br>    "memory": [<br>      "314GB",<br>      "306GB"<br>    ],<br>    "nics": 8,<br>    "nvme": 6<br>  },<br>  "Standard_L48s_v4": {<br>    "compute": 3,<br>    "drive": 3,<br>    "frontend": 1,<br>    "memory": [<br>      "314GB",<br>      "306GB"<br>    ],<br>    "nics": 8,<br>    "nvme": 6<br>  },<br>  "Standard_L64as_v3": {<br>    "compute": 4,<br>    "drive": 2,<br>    "frontend": 1,<br>    "memory": [<br>      "384GB",<br>      "384GB"<br>    ],<br>    "nics": 8,<br>    "nvme": 8<br>  },<br>  "Standard_L64s_v3": {<br>    "compute": 4,<br>    "drive": 2,<br>    "frontend": 1,<br>    "memory": [<br>      "357GB",<br>      "384GB"<br>    ],<br>    "nics": 8,<br>    "nvme": 8<br>  },<br>  "Standard_L64s_v4": {<br>    "compute": 4,<br>    "drive": 2,<br>    "frontend": 1,<br>    "memory": [<br>      "357GB",<br>      "384GB"<br>    ],<br>    "nics": 8,<br>    "nvme": 8<br>  },<br>  "Standard_L80as_v3": {<br>    "compute": 4,<br>    "drive": 2,<br>    "frontend": 1,<br>    "memory": [<br>      "384GB",<br>      "384GB"<br>    ],<br>    "nics": 8,<br>    "nvme": 10<br>  },<br>  "Standard_L80s_v3": {<br>    "compute": 4,<br>    "drive": 2,<br>    "frontend": 1,<br>    "memory": [<br>      "384GB",<br>      "384GB"<br>    ],<br>    "nics": 8,<br>    "nvme": 10<br>  },<br>  "Standard_L80s_v4": {<br>    "compute": 4,<br>    "drive": 2,<br>    "frontend": 1,<br>    "memory": [<br>      "384GB",<br>      "384GB"<br>    ],<br>    "nics": 8,<br>    "nvme": 10<br>  },<br>  "Standard_L8as_v3": {<br>    "compute": 1,<br>    "drive": 1,<br>    "frontend": 1,<br>    "memory": [<br>      "29GB",<br>      "29GB"<br>    ],<br>    "nics": 4,<br>    "nvme": 1<br>  },<br>  "Standard_L8s_v3": {<br>    "compute": 1,<br>    "drive": 1,<br>    "frontend": 1,<br>    "memory": [<br>      "33GB",<br>      "31GB"<br>    ],<br>    "nics": 4,<br>    "nvme": 1<br>  },<br>  "Standard_L8s_v4": {<br>    "compute": 1,<br>    "drive": 1,<br>    "frontend": 1,<br>    "memory": [<br>      "33GB",<br>      "31GB"<br>    ],<br>    "nics": 4,<br>    "nvme": 4<br>  },<br>  "Standard_L96s_v4": {<br>    "compute": 4,<br>    "drive": 2,<br>    "frontend": 1,<br>    "memory": [<br>      "384GB",<br>      "384GB"<br>    ],<br>    "nics": 8,<br>    "nvme": 12<br>  }<br>}</pre> | no |
...
| <a name="input_data_services_disk_size"></a> [data\_services\_disk\_size](#input\_data\_services\_disk\_size) | The data services' default disk size. | `number` | `48` | no |
| <a name="input_data_services_identity_name"></a> [data\_services\_identity\_name](#input\_data\_services\_identity\_name) | The user assigned identity name for the data services instances (if empty - new one is created). | `string` | `""` | no |
| <a name="input_data_services_instance_type"></a> [data\_services\_instance\_type](#input\_data\_services\_instance\_type) | The data services' virtual machine type (sku) to deploy. | `string` | `"Standard_D4s_v5"` | no |
| <a name="input_data_services_number"></a> [data\_services\_number](#input\_data\_services\_number) | The number of virtual machines to deploy as data services. | `number` | `0` | no |
| <a name="input_data_services_root_volume_size"></a> [data\_services\_root\_volume\_size](#input\_data\_services\_root\_volume\_size) | The data services' root disk size. | `number` | `null` | no |
| <a name="input_data_services_weka_cgroups_mode"></a> [data\_services\_weka\_cgroups\_mode](#input\_data\_services\_weka\_cgroups\_mode) | Weka cgroups mode for data services instances. Valid values are 'auto' and 'force\_v2'. | `string` | `"force_v2"` | no |
...
| <a name="input_function_app_version"></a> [function\_app\_version](#input\_function\_app\_version) | Function app code version (hash) | `string` | `"c2cb45a2f1e6b8e4e99bdf52b9230378"` | no |
...
| <a name="input_nfs_setup_protocol"></a> [nfs\_setup\_protocol](#input\_nfs\_setup\_protocol) | Config protocol, default if false | `bool` | `true` | no |
...
| <a name="input_s3_setup_protocol"></a> [s3\_setup\_protocol](#input\_s3\_setup\_protocol) | Config protocol, default if false | `bool` | `true` | no |
...
| <a name="input_smb_setup_protocol"></a> [smb\_setup\_protocol](#input\_smb\_setup\_protocol) | Config protocol, default if false | `bool` | `true` | no |
...
| <a name="input_source_image_id"></a> [source\_image\_id](#input\_source\_image\_id) | Use weka custom image, ubuntu 22.04 with kernel 6.8.0. When null, defaults to the weka custom image matching the instance\_type (an NVMe image for Lsv4 SKUs, otherwise weka\_custom\_image 3.0.0). Ignored if image\_sku is set. | `string` | `null` | no |
...
| <a name="output_data_services_ips"></a> [data\_services\_ips](#output\_data\_services\_ips) | If 'private\_network' is set to false, it will output the data services public ips, otherwise private ips. |
| <a name="output_data_services_vmss_name"></a> [data\_services\_vmss\_name](#output\_data\_services\_vmss\_name) | Data services vmss name |
