...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_aks_clients"></a> [aks\_clients](#module\_aks\_clients) | ./modules/aks | n/a |
...
| <a name="input_aks_client_frontend_cores"></a> [aks\_client\_frontend\_cores](#input\_aks\_client\_frontend\_cores) | The client NICs number. | `number` | `1` | no |
| <a name="input_aks_client_instance_type"></a> [aks\_client\_instance\_type](#input\_aks\_client\_instance\_type) | The client virtual machine type (sku) to deploy. | `string` | `"Standard_L8s_v3"` | no |
| <a name="input_aks_clients"></a> [aks\_clients](#input\_aks\_clients) | Create AKS clients | `bool` | `false` | no |
| <a name="input_aks_instances_number"></a> [aks\_instances\_number](#input\_aks\_instances\_number) | The number of client nodepool to deploy. | `number` | `3` | no |
...
| <a name="input_function_app_version"></a> [function\_app\_version](#input\_function\_app\_version) | Function app code version (hash) | `string` | `"f94eb16d930343b8b79511cdcf8ea8e4"` | no |
...
| <a name="output_weka_cluster_aks_node_pool_update_k8_yamls_path"></a> [weka\_cluster\_aks\_node\_pool\_update\_k8\_yamls\_path](#output\_weka\_cluster\_aks\_node\_pool\_update\_k8\_yamls\_path) | n/a |
| <a name="output_weka_cluster_aks_node_pool_update_script"></a> [weka\_cluster\_aks\_node\_pool\_update\_script](#output\_weka\_cluster\_aks\_node\_pool\_update\_script) | n/a |
<!-- END_TF_DOCS -->
