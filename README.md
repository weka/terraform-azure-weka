...
| <a name="input_client_instance_type_map"></a> [client\_instance\_type\_map](#input\_client\_instance\_type\_map) | The client virtual machine type (sku) to deploy. | <pre>object({<br>    x86_64 = string<br>    arm64  = string<br>  })</pre> | <pre>{<br>  "arm64": "Standard_E2ps_v5",<br>  "x86_64": "Standard_D8_v5"<br>}</pre> | no |
...
| <a name="input_function_app_version"></a> [function\_app\_version](#input\_function\_app\_version) | Function app code version (hash) | `string` | `"64b82f6331447d6bbd9ac6d7b4b1d494"` | no |
