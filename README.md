...
| [azurerm_public_ip.ui_lb_ip](https://registry.terraform.io/providers/hashicorp/azurerm/latest/docs/resources/public_ip) | resource |
...
| <a name="input_function_app_version"></a> [function\_app\_version](#input\_function\_app\_version) | Function app code version (hash) | `string` | `"8e19f1ecccdf27cfc78d95cb2fb84277"` | no |
...
| <a name="input_subnet_autocreate_as_private"></a> [subnet\_autocreate\_as\_private](#input\_subnet\_autocreate\_as\_private) | Create private subnet without outbound to internet route traffic. The default is public network. Relevant only when sg\_id is empty. | `bool` | `false` | no |
