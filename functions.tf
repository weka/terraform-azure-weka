...
resource "azurerm_linux_function_app" "function_app" {
  ...
  app_settings = {
    ...
    "INSTALL_URL" =  var.install_weka_url != "" ? var.install_weka_url : "https://$TOKEN@get.prod.weka.io/dist/v1/install/4.2.1-46c4ca6f08f141014d0c187ec0c74d70/4.2.1.9934-0f2133bece926d75ba447759e4d4cb46"
