...
| <a name="input_subnets_delegation_names"></a> [subnets\_delegation\_names](#input\_subnets\_delegation\_names) | List of subnet delegation names | `list(string)` | n/a | yes |
